...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE_NAME_PASSWORD + "( " + PASSWORD_COLUMN_ID + " integer primary key autoincrement, " + PASSWORD_COLUMN_PASSWORD + " text not null);";
